...
const file_data_proto_rawDesc = "" +
	"\n" +
	"\n" +
	"data.proto\x12\x04data\x1a\x19google/protobuf/any.proto\x1a\x1bgoogle/protobuf/empty.proto\x1a\fschema.proto\"\xd0\x01\n" +
	...
	"\x06format\x18\x03 \x01(\x0e2\f.data.FormatR\x06format\"\xa6\x01\n" +
	...
	"\x04blob\x18\x04 \x01(\fH\x00R\x04blobB\b\n" +
	"\x06intent\"\x9c\x02\n" +
	...
	"\x06orphan\x18\x05 \x01(\bR\x06orphan\"\xa5\x02\n" +
	...
	"\x10commit_candidate\x18\b \x01(\x0e2\x15.data.CommitCandidateR\x0fcommitCandidate\")\n" +
	"\vGnmiOptions\x12\x1a\n" +
	"\bencoding\x18\v \x01(\tR\bencoding\"\xef\x02\n" +
	"\x06Target\x12\x12\n" +
	...
	"\x0fdeviation_value\x18\x04 \x01(\v2\x10.data.TypedValueR\x0edeviationValue\x12.\n" +
	"\x06childs\x18\n" +
	" \x03(\v2\x16.data.BlameTreeElementR\x06childs*m\n" +
	"\x06Format\x12\x16\n" +
	"\x12Intent_Format_JSON\x10\x00\x12\x1b\n" +
	"\x17Intent_Format_JSON_IETF\x10\x01\x12\x15\n" +
	"\x11Intent_Format_XML\x10\x02\x12\x17\n" +
	"\x13Intent_Format_PROTO\x10\x03*K\n" +
	...
	"\vBlameConfig\x12\x18.data.BlameConfigRequest\x1a\x19.data.BlameConfigResponseB\x11Z\x0f.;schema_serverb\x06proto3"
