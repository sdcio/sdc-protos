...
const (
	...
	Format_Intent_Format_XPATH     Format = 4
)
...
type GetIntentRequest struct {
	...
	// when true the render pipeline skips redaction and returns plaintext values
...
func (x *GetIntentRequest) GetIncludeSensitive() bool {
	if x != nil {
...
type GetIntentResponse struct {
	...
	NonRevertive bool `protobuf:"varint,8,opt,name=non_revertive,json=nonRevertive,proto3" json:"non_revertive,omitempty"`
	// explicit deletes that remain as part of the intent
	Deletes []*Path `protobuf:"bytes,9,rep,name=deletes,proto3" json:"deletes,omitempty"`
}
...
func (x *GetIntentResponse) GetIntentName() string {
	if x != nil {
		return x.IntentName
	}
	return ""
...
func (x *GetIntentResponse) GetPriority() int32 {
	if x != nil {
		return x.Priority
	}
	return 0
...
func (x *GetIntentResponse) GetOrphan() bool {
	if x != nil {
		return x.Orphan
	}
	return false
...
func (x *GetIntentResponse) GetNonRevertive() bool {
	if x != nil {
...
func (x *GetIntentResponse) GetDeletes() []*Path {
	if x != nil {
		return x.Deletes
	}
	return nil
...
type TransactionIntent struct {
	...
	// paths that are meant to be reverted
	RevertPaths []*Path `protobuf:"bytes,10,rep,name=revert_paths,json=revertPaths,proto3" json:"revert_paths,omitempty"`
	// keyless XPath strings (e.g. /bgp/neighbors/auth-password) identifying
	// leaves whose values must be redacted in northbound responses. Paths with
	// key predicates are rejected by the server. Absence is treated as an empty
	// slice (non-sensitive). A replace intent must re-declare all sensitive paths
	// it considers sensitive; prior intents' slices are removed along with those
	// intents.
	SensitivePaths []*Path `protobuf:"bytes,11,rep,name=sensitive_paths,json=sensitivePaths,proto3" json:"sensitive_paths,omitempty"`
}
...
func (x *TransactionIntent) GetRevertPaths() []*Path {
	if x != nil {
		return x.RevertPaths
	}
	return nil
}

func (x *TransactionIntent) GetSensitivePaths() []*Path {
	if x != nil {
...
func (x *GnmiOptions) GetTargetName() string {
	if x != nil {
		return x.TargetName
	}
	return ""
...
func (x *BlameConfigRequest) GetIncludeSensitive() bool {
	if x != nil {
		return x.IncludeSensitive
	}
	return false
...
type BlameTreeElement struct {
	...
	// key_name is set in case the level in the tree is a key level of a list.
...
func (x *BlameTreeElement) GetKeyName() string {
	if x != nil {
		return x.KeyName
	}
	return ""
...
func (x *PathValue) GetValue() *TypedValue {
	if x != nil {
		return x.Value
	}
	return nil
...
type PathValues struct {
	...
	PathValues []*PathValue `protobuf:"bytes,1,rep,name=path_values,json=pathValues,proto3" json:"path_values,omitempty"`
}

func (x *PathValues) Reset() {
	*x = PathValues{}
...
func (x *PathValues) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PathValues) ProtoMessage() {}

func (x *PathValues) ProtoReflect() protoreflect.Message {
	mi := &file_data_proto_msgTypes[49]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PathValues.ProtoReflect.Descriptor instead.
func (*PathValues) Descriptor() ([]byte, []int) {
	return file_data_proto_rawDescGZIP(), []int{49}
}

func (x *PathValues) GetPathValues() []*PathValue {
	if x != nil {
		return x.PathValues
	}
	return nil
...
var file_data_proto_rawDesc = []byte{
	...
	0x6d, 0x70, 0x74, 0x79, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x0d, 0x6f, 0x70, 0x74, 0x69,
	0x6f, 0x6e, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x0c, 0x73, 0x63, 0x68, 0x65, 0x6d,
	0x61, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xd0, 0x01, 0x0a, 0x0e, 0x47, 0x65, 0x74, 0x44,
	...
	,
	...
	0x03, 0x28, 0x0b, 0x32, 0x12, 0x2e, 0x64, 0x61, 0x74, 0x61, 0x2e, 0x4e, 0x6f, 0x74, 0x69, 0x66,
	0x69, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x0c, 0x6e, 0x6f, 0x74, 0x69, 0x66, 0x69, 0x63,
	0x61, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0xc7, 0x01, 0x0a, 0x0e, 0x53, 0x65, 0x74, 0x44, 0x61, 0x74,
	...
	,
	...
	0x0b, 0x32, 0x1a, 0x2e, 0x64, 0x61, 0x74, 0x61, 0x2e, 0x47, 0x65, 0x74, 0x44, 0x61, 0x74, 0x61,
	0x53, 0x74, 0x6f, 0x72, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x52, 0x0a, 0x64,
	0x61, 0x74, 0x61, 0x73, 0x74, 0x6f, 0x72, 0x65, 0x73, 0x22, 0x3c, 0x0a, 0x13, 0x47, 0x65, 0x74,
	...
	,
	...
	0x6e, 0x73, 0x65, 0x22, 0xa4, 0x01, 0x0a, 0x10, 0x47, 0x65, 0x74, 0x49, 0x6e, 0x74, 0x65, 0x6e,
	...
	,
	...
	,
	...
	,
	...
	0x09, 0x52, 0x06, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x73, 0x22, 0x68, 0x0a, 0x18, 0x54, 0x72, 0x61,
	0x6e, 0x73, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x43, 0x61, 0x6e, 0x63, 0x65, 0x6c, 0x52, 0x65,
	...
	0x6e, 0x49, 0x64, 0x22, 0x1b, 0x0a, 0x19, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x61, 0x63, 0x74, 0x69,
	0x6f, 0x6e, 0x43, 0x61, 0x6e, 0x63, 0x65, 0x6c, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65,
	0x22, 0x69, 0x0a, 0x19, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x43,
	0x6f, 0x6e, 0x66, 0x69, 0x72, 0x6d, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x25, 0x0a,
	...
	0x61, 0x6e, 0x73, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x49, 0x64, 0x22, 0x1c, 0x0a, 0x1a, 0x54,
	0x72, 0x61, 0x6e, 0x73, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x72,
	0x6d, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x3a, 0x0a, 0x11, 0x4c, 0x69, 0x73,
	0x74, 0x49, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x25,
	...
	0x65, 0x4e, 0x61, 0x6d, 0x65, 0x22, 0x53, 0x0a, 0x12, 0x4c, 0x69, 0x73, 0x74, 0x49, 0x6e, 0x74,
	...
	,
	...
	0x12, 0x2f, 0x0a, 0x0a, 0x6d, 0x61, 0x69, 0x6e, 0x5f, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x18, 0x02,
	...
	0x65, 0x12, 0x39, 0x0a, 0x0f, 0x63, 0x61, 0x6e, 0x64, 0x69, 0x64, 0x61, 0x74, 0x65, 0x5f, 0x76,
	0x61, 0x6c, 0x75, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x10, 0x2e, 0x64, 0x61, 0x74,
	0x61, 0x2e, 0x54, 0x79, 0x70, 0x65, 0x64, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x52, 0x0e, 0x63, 0x61,
	0x6e, 0x64, 0x69, 0x64, 0x61, 0x74, 0x65, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x22, 0x9f, 0x05, 0x0a,
	0x0a, 0x54, 0x79, 0x70, 0x65, 0x64, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x12, 0x1c, 0x0a, 0x09, 0x74,
	0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x18, 0x01, 0x20, 0x01, 0x28, 0x04, 0x52, 0x09,
	0x74, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x12, 0x1f, 0x0a, 0x0a, 0x73, 0x74, 0x72,
	...
	,
	...
	0x65, 0x18, 0x05, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x0c, 0x2e, 0x73, 0x63, 0x68, 0x65, 0x6d, 0x61,
	0x2e, 0x50, 0x61, 0x74, 0x68, 0x52, 0x06, 0x64, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x22, 0x51, 0x0a,
	0x09, 0x44, 0x61, 0x74, 0x61, 0x53, 0x74, 0x6f, 0x72, 0x65, 0x12, 0x12, 0x0a, 0x04, 0x6e, 0x61,
	...
	,
	...
	,
	...
	0x65, 0x74, 0x61, 0x69, 0x6c, 0x73, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0d, 0x73, 0x74,
	0x61, 0x74, 0x75, 0x73, 0x44, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x73, 0x42, 0x11, 0x0a, 0x0f, 0x70,
	0x72, 0x6f, 0x74, 0x6f, 0x63, 0x6f, 0x6c, 0x4f, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x22, 0x65,
	...
	0x01, 0x28, 0x09, 0x52, 0x04, 0x63, 0x65, 0x72, 0x74, 0x12, 0x19, 0x0a, 0x03, 0x6b, 0x65, 0x79,
	0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x42, 0x07, 0xb0, 0x86, 0x19, 0x01, 0x80, 0x01, 0x01, 0x52,
	...
	,
	...
	,
	...
	,
	...
	0x72, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x6f, 0x77, 0x6e, 0x65, 0x72, 0x12, 0x26,
	...
	0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x12, 0x39, 0x0a, 0x0f, 0x64, 0x65, 0x76, 0x69, 0x61, 0x74,
	0x69, 0x6f, 0x6e, 0x5f, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0b, 0x32,
	0x10, 0x2e, 0x64, 0x61, 0x74, 0x61, 0x2e, 0x54, 0x79, 0x70, 0x65, 0x64, 0x56, 0x61, 0x6c, 0x75,
	0x65, 0x52, 0x0e, 0x64, 0x65, 0x76, 0x69, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x56, 0x61, 0x6c, 0x75,
	0x65, 0x12, 0x19, 0x0a, 0x08, 0x6b, 0x65, 0x79, 0x5f, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x05, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x07, 0x6b, 0x65, 0x79, 0x4e, 0x61, 0x6d, 0x65, 0x12, 0x2e, 0x0a, 0x06,
	...
	,
	...
	,
	...
	,
}
...
var file_data_proto_goTypes = []any{
	...
	(*PathValue)(nil),                    // 56: data.PathValue
	(*PathValues)(nil),                   // 57: data.PathValues
	nil,                                  // 58: data.TransactionSetResponse.IntentsEntry
	(*Path)(nil),                         // 59: schema.Path
	(DataType)(0),                        // 60: schema.DataType
	(*Schema)(nil),                       // 61: schema.Schema
...
var file_data_proto_depIdxs = []int32{
	...
	59, // 1: data.GetDataRequest.path:type_name -> schema.Path
	60, // 2: data.GetDataRequest.data_type:type_name -> schema.DataType
	...
	59, // 8: data.SetDataRequest.delete:type_name -> schema.Path
	...
	61, // 11: data.GetDataStoreResponse.schema:type_name -> schema.Schema
	45, // 12: data.GetDataStoreResponse.target:type_name -> data.Target
	61, // 13: data.CreateDataStoreRequest.schema:type_name -> schema.Schema
	...
	59, // 19: data.GetIntentResponse.deletes:type_name -> schema.Path
	23, // 20: data.TransactionSetRequest.intents:type_name -> data.TransactionIntent
	23, // 21: data.TransactionSetRequest.replace_intent:type_name -> data.TransactionIntent
	34, // 22: data.TransactionIntent.update:type_name -> data.Update
	59, // 23: data.TransactionIntent.deletes:type_name -> schema.Path
	59, // 24: data.TransactionIntent.revert_paths:type_name -> schema.Path
	59, // 25: data.TransactionIntent.sensitive_paths:type_name -> schema.Path
	34, // 26: data.TransactionSetResponse.update:type_name -> data.Update
	59, // 27: data.TransactionSetResponse.delete:type_name -> schema.Path
	58, // 28: data.TransactionSetResponse.intents:type_name -> data.TransactionSetResponse.IntentsEntry
	1,  // 29: data.WatchDeviationResponse.event:type_name -> data.DeviationEvent
	2,  // 30: data.WatchDeviationResponse.reason:type_name -> data.DeviationReason
	59, // 31: data.WatchDeviationResponse.path:type_name -> schema.Path
	36, // 32: data.WatchDeviationResponse.expected_value:type_name -> data.TypedValue
	36, // 33: data.WatchDeviationResponse.current_value:type_name -> data.TypedValue
	59, // 34: data.Update.path:type_name -> schema.Path
	36, // 35: data.Update.value:type_name -> data.TypedValue
	59, // 36: data.DiffUpdate.path:type_name -> schema.Path
	36, // 37: data.DiffUpdate.main_value:type_name -> data.TypedValue
	36, // 38: data.DiffUpdate.candidate_value:type_name -> data.TypedValue
	41, // 39: data.TypedValue.decimal_val:type_name -> data.Decimal64
	42, // 40: data.TypedValue.leaflist_val:type_name -> data.ScalarArray
	62, // 41: data.TypedValue.any_val:type_name -> google.protobuf.Any
	63, // 42: data.TypedValue.empty_val:type_name -> google.protobuf.Empty
	37, // 43: data.TypedValue.identityref_val:type_name -> data.IdentityRef
	59, // 44: data.UpdateResult.path:type_name -> schema.Path
	7,  // 45: data.UpdateResult.op:type_name -> data.UpdateResult.Operation
	34, // 46: data.Notification.update:type_name -> data.Update
	59, // 47: data.Notification.delete:type_name -> schema.Path
	36, // 48: data.ScalarArray.element:type_name -> data.TypedValue
	5,  // 49: data.NetconfOptions.commit_candidate:type_name -> data.CommitCandidate
	46, // 50: data.Target.tls:type_name -> data.TLS
	47, // 51: data.Target.credentials:type_name -> data.Credentials
	44, // 52: data.Target.gnmi_opts:type_name -> data.GnmiOptions
	43, // 53: data.Target.netconf_opts:type_name -> data.NetconfOptions
	4,  // 54: data.Target.status:type_name -> data.TargetStatus
	49, // 55: data.Sync.config:type_name -> data.SyncConfig
	45, // 56: data.SyncConfig.target:type_name -> data.Target
	6,  // 57: data.SyncConfig.mode:type_name -> data.SyncMode
	59, // 58: data.Subscription.path:type_name -> schema.Path
	60, // 59: data.Subscription.data_type:type_name -> schema.DataType
	59, // 60: data.Watch.path:type_name -> schema.Path
	60, // 61: data.Watch.data_type:type_name -> schema.DataType
	34, // 62: data.Intent.update:type_name -> data.Update
	55, // 63: data.BlameConfigResponse.config_tree:type_name -> data.BlameTreeElement
	36, // 64: data.BlameTreeElement.value:type_name -> data.TypedValue
	36, // 65: data.BlameTreeElement.deviation_value:type_name -> data.TypedValue
	55, // 66: data.BlameTreeElement.childs:type_name -> data.BlameTreeElement
	59, // 67: data.PathValue.path:type_name -> schema.Path
	36, // 68: data.PathValue.value:type_name -> data.TypedValue
	56, // 69: data.PathValues.path_values:type_name -> data.PathValue
	25, // 70: data.TransactionSetResponse.IntentsEntry.value:type_name -> data.TransactionSetResponseIntent
	12, // 71: data.DataServer.ListDataStore:input_type -> data.ListDataStoreRequest
	14, // 72: data.DataServer.GetDataStore:input_type -> data.GetDataStoreRequest
	16, // 73: data.DataServer.CreateDataStore:input_type -> data.CreateDataStoreRequest
	18, // 74: data.DataServer.DeleteDataStore:input_type -> data.DeleteDataStoreRequest
	22, // 75: data.DataServer.TransactionSet:input_type -> data.TransactionSetRequest
	28, // 76: data.DataServer.TransactionConfirm:input_type -> data.TransactionConfirmRequest
	26, // 77: data.DataServer.TransactionCancel:input_type -> data.TransactionCancelRequest
	30, // 78: data.DataServer.ListIntent:input_type -> data.ListIntentRequest
	20, // 79: data.DataServer.GetIntent:input_type -> data.GetIntentRequest
	32, // 80: data.DataServer.WatchDeviations:input_type -> data.WatchDeviationRequest
	53, // 81: data.DataServer.BlameConfig:input_type -> data.BlameConfigRequest
	13, // 82: data.DataServer.ListDataStore:output_type -> data.ListDataStoreResponse
	15, // 83: data.DataServer.GetDataStore:output_type -> data.GetDataStoreResponse
	17, // 84: data.DataServer.CreateDataStore:output_type -> data.CreateDataStoreResponse
	19, // 85: data.DataServer.DeleteDataStore:output_type -> data.DeleteDataStoreResponse
	24, // 86: data.DataServer.TransactionSet:output_type -> data.TransactionSetResponse
	29, // 87: data.DataServer.TransactionConfirm:output_type -> data.TransactionConfirmResponse
	27, // 88: data.DataServer.TransactionCancel:output_type -> data.TransactionCancelResponse
	31, // 89: data.DataServer.ListIntent:output_type -> data.ListIntentResponse
	21, // 90: data.DataServer.GetIntent:output_type -> data.GetIntentResponse
	33, // 91: data.DataServer.WatchDeviations:output_type -> data.WatchDeviationResponse
	54, // 92: data.DataServer.BlameConfig:output_type -> data.BlameConfigResponse
