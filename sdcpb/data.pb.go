...
func (UpdateResult_Operation) EnumDescriptor() ([]byte, []int) {
	return file_data_proto_rawDescGZIP(), []int{27, 0}
}
...
var file_data_proto_rawDesc = []byte{
	...
	0xaa, 0x04, 0x0a, 0x0a, 0x54, 0x79, 0x70, 0x65, 0x64, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x12, 0x1c,
	...
	0x74, 0x65, 0x73, 0x42, 0x07, 0x0a, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x22, 0x9d, 0x01, 0x0a,
	...
	0x64, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x22, 0x71, 0x0a, 0x09, 0x44, 0x61, 0x74, 0x61, 0x53, 0x74,
	0x6f, 0x72, 0x65, 0x12, 0x1e, 0x0a, 0x04, 0x74, 0x79, 0x70, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x0e, 0x32, 0x0a, 0x2e, 0x64, 0x61, 0x74, 0x61, 0x2e, 0x54, 0x79, 0x70, 0x65, 0x52, 0x04, 0x74,
	...
	0x65, 0x6c, 0x65, 0x6d, 0x65, 0x6e, 0x74, 0x22, 0x88, 0x01, 0x0a, 0x06, 0x54, 0x61, 0x72, 0x67,
	...
	0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0x83, 0x01,
	...
	0x22, 0x0a, 0x04, 0x67, 0x6e, 0x6d, 0x69, 0x18, 0x04, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x0e, 0x2e,
	0x64, 0x61, 0x74, 0x61, 0x2e, 0x47, 0x4e, 0x4d, 0x49, 0x53, 0x79, 0x6e, 0x63, 0x52, 0x04, 0x67,
	0x6e, 0x6d, 0x69, 0x22, 0x8e, 0x01, 0x0a, 0x08, 0x47, 0x4e, 0x4d, 0x49, 0x53, 0x79, 0x6e, 0x63,
	0x12, 0x12, 0x0a, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04,
	...
	0x49, 0x6e, 0x74, 0x65, 0x72, 0x76, 0x61, 0x6c, 0x2a, 0x2d, 0x0a, 0x04, 0x54, 0x79, 0x70, 0x65,
	...
	0x45, 0x4e, 0x44, 0x45, 0x44, 0x10, 0x02, 0x2a, 0x38, 0x0a, 0x08, 0x53, 0x79, 0x6e, 0x63, 0x4d,
	...
	0x02, 0x32, 0xf4, 0x05, 0x0a, 0x0a, 0x44, 0x61, 0x74, 0x61, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72,
...
var file_data_proto_msgTypes = make([]protoimpl.MessageInfo, 39)
var file_data_proto_goTypes = []interface{}{
	...
	(*UpdateResult)(nil),            // 30: data.UpdateResult
	(*Notification)(nil),            // 31: data.Notification
	(*DataStore)(nil),               // 32: data.DataStore
	(*Decimal64)(nil),               // 33: data.Decimal64
	(*ScalarArray)(nil),             // 34: data.ScalarArray
	(*Target)(nil),                  // 35: data.Target
	(*TLS)(nil),                     // 36: data.TLS
	(*Credentials)(nil),             // 37: data.Credentials
	(*Sync)(nil),                    // 38: data.Sync
	(*GNMISync)(nil),                // 39: data.GNMISync
	(*Subscription)(nil),            // 40: data.Subscription
	(*Watch)(nil),                   // 41: data.Watch
	(*Path)(nil),                    // 42: schema.Path
	(DataType)(0),                   // 43: schema.DataType
	(*Schema)(nil),                  // 44: schema.Schema
	(*any.Any)(nil),                 // 45: google.protobuf.Any
}
var file_data_proto_depIdxs = []int32{
	32, // 0: data.GetDataRequest.datastore:type_name -> data.DataStore
	42, // 1: data.GetDataRequest.path:type_name -> schema.Path
	43, // 2: data.GetDataRequest.data_type:type_name -> schema.DataType
	31, // 3: data.GetDataResponse.notification:type_name -> data.Notification
	32, // 4: data.SetDataRequest.datastore:type_name -> data.DataStore
	27, // 5: data.SetDataRequest.update:type_name -> data.Update
	27, // 6: data.SetDataRequest.replace:type_name -> data.Update
	42, // 7: data.SetDataRequest.delete:type_name -> schema.Path
	30, // 8: data.SetDataResponse.response:type_name -> data.UpdateResult
	32, // 9: data.DiffRequest.datastore:type_name -> data.DataStore
	32, // 10: data.DiffResponse.datastore:type_name -> data.DataStore
	28, // 11: data.DiffResponse.diff:type_name -> data.DiffUpdate
	40, // 12: data.SubscribeRequest.subscription:type_name -> data.Subscription
	31, // 13: data.SubscribeResponse.update:type_name -> data.Notification
	14, // 14: data.ListDataStoreResponse.datastores:type_name -> data.GetDataStoreResponse
	32, // 15: data.GetDataStoreResponse.datastore:type_name -> data.DataStore
	44, // 16: data.GetDataStoreResponse.schema:type_name -> schema.Schema
	35, // 17: data.GetDataStoreResponse.target:type_name -> data.Target
	32, // 18: data.CreateDataStoreRequest.datastore:type_name -> data.DataStore
	44, // 19: data.CreateDataStoreRequest.schema:type_name -> schema.Schema
	35, // 20: data.CreateDataStoreRequest.target:type_name -> data.Target
	38, // 21: data.CreateDataStoreRequest.sync:type_name -> data.Sync
	32, // 22: data.DeleteDataStoreRequest.datastore:type_name -> data.DataStore
	32, // 23: data.CommitRequest.datastore:type_name -> data.DataStore
	32, // 24: data.RebaseRequest.datastore:type_name -> data.DataStore
	32, // 25: data.DiscardRequest.datastore:type_name -> data.DataStore
	41, // 26: data.WatchRequest.watch:type_name -> data.Watch
	31, // 27: data.WatchResponse.notification:type_name -> data.Notification
	42, // 28: data.Update.path:type_name -> schema.Path
	29, // 29: data.Update.value:type_name -> data.TypedValue
	42, // 30: data.DiffUpdate.path:type_name -> schema.Path
	...
	33, // 33: data.TypedValue.decimal_val:type_name -> data.Decimal64
	34, // 34: data.TypedValue.leaflist_val:type_name -> data.ScalarArray
	45, // 35: data.TypedValue.any_val:type_name -> google.protobuf.Any
	42, // 36: data.UpdateResult.path:type_name -> schema.Path
	2,  // 37: data.UpdateResult.op:type_name -> data.UpdateResult.Operation
	27, // 38: data.Notification.update:type_name -> data.Update
	42, // 39: data.Notification.delete:type_name -> schema.Path
	0,  // 40: data.DataStore.type:type_name -> data.Type
	29, // 41: data.ScalarArray.element:type_name -> data.TypedValue
	36, // 42: data.Target.tls:type_name -> data.TLS
	37, // 43: data.Target.credentials:type_name -> data.Credentials
	39, // 44: data.Sync.gnmi:type_name -> data.GNMISync
	1,  // 45: data.GNMISync.mode:type_name -> data.SyncMode
	42, // 46: data.Subscription.path:type_name -> schema.Path
	43, // 47: data.Subscription.data_type:type_name -> schema.DataType
	42, // 48: data.Watch.path:type_name -> schema.Path
	43, // 49: data.Watch.data_type:type_name -> schema.DataType
	11, // 50: data.DataServer.ListDataStore:input_type -> data.ListDataStoreRequest
	13, // 51: data.DataServer.GetDataStore:input_type -> data.GetDataStoreRequest
	15, // 52: data.DataServer.CreateDataStore:input_type -> data.CreateDataStoreRequest
	17, // 53: data.DataServer.DeleteDataStore:input_type -> data.DeleteDataStoreRequest
	19, // 54: data.DataServer.Commit:input_type -> data.CommitRequest
	21, // 55: data.DataServer.Rebase:input_type -> data.RebaseRequest
	23, // 56: data.DataServer.Discard:input_type -> data.DiscardRequest
	3,  // 57: data.DataServer.GetData:input_type -> data.GetDataRequest
	5,  // 58: data.DataServer.SetData:input_type -> data.SetDataRequest
	7,  // 59: data.DataServer.Diff:input_type -> data.DiffRequest
	9,  // 60: data.DataServer.Subscribe:input_type -> data.SubscribeRequest
	25, // 61: data.DataServer.Watch:input_type -> data.WatchRequest
	12, // 62: data.DataServer.ListDataStore:output_type -> data.ListDataStoreResponse
	14, // 63: data.DataServer.GetDataStore:output_type -> data.GetDataStoreResponse
	16, // 64: data.DataServer.CreateDataStore:output_type -> data.CreateDataStoreResponse
	18, // 65: data.DataServer.DeleteDataStore:output_type -> data.DeleteDataStoreResponse
	20, // 66: data.DataServer.Commit:output_type -> data.CommitResponse
	22, // 67: data.DataServer.Rebase:output_type -> data.RebaseResponse
	24, // 68: data.DataServer.Discard:output_type -> data.DiscardResponse
	4,  // 69: data.DataServer.GetData:output_type -> data.GetDataResponse
	6,  // 70: data.DataServer.SetData:output_type -> data.SetDataResponse
	8,  // 71: data.DataServer.Diff:output_type -> data.DiffResponse
	10, // 72: data.DataServer.Subscribe:output_type -> data.SubscribeResponse
	26, // 73: data.DataServer.Watch:output_type -> data.WatchResponse
