...
type ContainerSchema struct {
	...
	// unique_constraints holds the YANG `unique` constraints (RFC 7950 § 7.8.3)
	// for list nodes. Each entry represents one `unique` statement; the
	// `elements` field carries the space-split descendant schema-node identifiers
	// named in that statement (e.g. `unique "ip port"` → ["ip", "port"]).
	UniqueConstraints []*UniqueConstraint `protobuf:"bytes,24,rep,name=unique_constraints,json=uniqueConstraints,proto3" json:"unique_constraints,omitempty"`
...
func (x *ContainerSchema) GetUniqueConstraints() []*UniqueConstraint {
	if x != nil {
...
// UniqueConstraint represents one YANG `unique` statement on a list node.
// Each element is a descendant schema-node identifier (RFC 7950 § 14);
// together they form the tuple that must be unique across all list entries.
...
func (x *UniqueConstraint) GetElements() []string {
	if x != nil {
		return x.Elements
	}
	return nil
...
type SchemaLeafType struct {
	...
	IdentityPrefixesMap map[string]string `protobuf:"bytes,11,rep,name=identity_prefixes_map,json=identityPrefixesMap,proto3" json:"identity_prefixes_map,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	ModulePrefixMap     map[string]string `protobuf:"bytes,12,rep,name=module_prefix_map,json=modulePrefixMap,proto3" json:"module_prefix_map,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
...
type Path struct {
	...
	IsRootBased bool        `protobuf:"varint,5,opt,name=is_root_based,json=isRootBased,proto3" json:"is_root_based,omitempty"`
}
...
func (x *Path) GetIsRootBased() bool {
	if x != nil {
		return x.IsRootBased
	}
	return false
}
...
type ChoiceInfo struct {
	...
	Choice map[string]*ChoiceInfoChoice `protobuf:"bytes,1,rep,name=choice,proto3" json:"choice,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
type ChoiceInfoChoice struct {
	...
	Case map[string]*ChoiceCase `protobuf:"bytes,1,rep,name=case,proto3" json:"case,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
var file_schema_proto_rawDesc = []byte{
	...
	0x73, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x22, 0x7c, 0x0a, 0x06, 0x53, 0x63, 0x68, 0x65, 0x6d, 0x61,
	...
	0x18, 0x05, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x14, 0x2e, 0x73, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x2e,
	0x53, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x52, 0x06, 0x73, 0x74,
	0x61, 0x74, 0x75, 0x73, 0x22, 0x41, 0x0a, 0x17, 0x47, 0x65, 0x74, 0x53, 0x63, 0x68, 0x65, 0x6d,
	0x61, 0x44, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12,
	0x26, 0x0a, 0x06, 0x73, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32,
	0x0e, 0x2e, 0x73, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x2e, 0x53, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x52,
	0x06, 0x73, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x22, 0x8e, 0x01, 0x0a, 0x18, 0x47, 0x65, 0x74, 0x53,
	...
	0x20, 0x01, 0x28, 0x0b, 0x32, 0x0e, 0x2e, 0x73, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x2e, 0x53, 0x63,
	...
	0x07, 0x65, 0x78, 0x63, 0x6c, 0x75, 0x64, 0x65, 0x22, 0x13, 0x0a, 0x11, 0x4c, 0x69, 0x73, 0x74,
	0x53, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x22, 0x3c, 0x0a,
	...
	0x65, 0x6d, 0x61, 0x52, 0x06, 0x73, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x22, 0xac, 0x01, 0x0a, 0x10,
	...
	0x74, 0x68, 0x12, 0x26, 0x0a, 0x06, 0x73, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x18, 0x02, 0x20, 0x01,
	...
	0x65, 0x73, 0x63, 0x72, 0x69, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0x3f, 0x0a, 0x11, 0x47, 0x65,
	0x74, 0x53, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12,
	0x2a, 0x0a, 0x06, 0x73, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32,
	0x12, 0x2e, 0x73, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x2e, 0x53, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x45,
	0x6c, 0x65, 0x6d, 0x52, 0x06, 0x73, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x22, 0xb1, 0x01, 0x0a, 0x0a,
	0x53, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x45, 0x6c, 0x65, 0x6d, 0x12, 0x37, 0x0a, 0x09, 0x63, 0x6f,
	...
	,
	...
	,
	...
	,
	...
	0x22, 0xa2, 0x01, 0x0a, 0x11, 0x45, 0x78, 0x70, 0x61, 0x6e, 0x64, 0x50, 0x61, 0x74, 0x68, 0x52,
	0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x20, 0x0a, 0x04, 0x70, 0x61, 0x74, 0x68, 0x18, 0x01,
	0x20, 0x01, 0x28, 0x0b, 0x32, 0x0c, 0x2e, 0x73, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x2e, 0x50, 0x61,
	0x74, 0x68, 0x52, 0x04, 0x70, 0x61, 0x74, 0x68, 0x12, 0x26, 0x0a, 0x06, 0x73, 0x63, 0x68, 0x65,
	0x6d, 0x61, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0e, 0x2e, 0x73, 0x63, 0x68, 0x65, 0x6d,
	0x61, 0x2e, 0x53, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x52, 0x06, 0x73, 0x63, 0x68, 0x65, 0x6d, 0x61,
	0x12, 0x2d, 0x0a, 0x09, 0x64, 0x61, 0x74, 0x61, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x18, 0x03, 0x20,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x65, 0x66, 0x69, 0x78, 0x12, 0x2a, 0x0a, 0x04, 0x74, 0x79, 0x70, 0x65, 0x18, 0x06, 0x20, 0x01,
	0x28, 0x0b, 0x32, 0x16, 0x2e, 0x73, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x2e, 0x53, 0x63, 0x68, 0x65,
	0x6d, 0x61, 0x4c, 0x65, 0x61, 0x66, 0x54, 0x79, 0x70, 0x65, 0x52, 0x04, 0x74, 0x79, 0x70, 0x65,
	0x12, 0x1c, 0x0a, 0x09, 0x65, 0x6e, 0x63, 0x72, 0x79, 0x70, 0x74, 0x65, 0x64, 0x18, 0x07, 0x20,
	0x01, 0x28, 0x08, 0x52, 0x09, 0x65, 0x6e, 0x63, 0x72, 0x79, 0x70, 0x74, 0x65, 0x64, 0x12, 0x1f,
	0x0a, 0x0b, 0x6d, 0x6f, 0x64, 0x75, 0x6c, 0x65, 0x5f, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x08, 0x20,
	...
	0x75, 0x6e, 0x69, 0x74, 0x73, 0x12, 0x3e, 0x0a, 0x0f, 0x6d, 0x75, 0x73, 0x74, 0x5f, 0x73, 0x74,
	0x61, 0x74, 0x65, 0x6d, 0x65, 0x6e, 0x74, 0x73, 0x18, 0x0b, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x15,
	0x2e, 0x73, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x2e, 0x4d, 0x75, 0x73, 0x74, 0x53, 0x74, 0x61, 0x74,
	0x65, 0x6d, 0x65, 0x6e, 0x74, 0x52, 0x0e, 0x6d, 0x75, 0x73, 0x74, 0x53, 0x74, 0x61, 0x74, 0x65,
	0x6d, 0x65, 0x6e, 0x74, 0x73, 0x12, 0x1a, 0x0a, 0x08, 0x64, 0x65, 0x66, 0x61, 0x75, 0x6c, 0x74,
	0x73, 0x18, 0x0c, 0x20, 0x03, 0x28, 0x09, 0x52, 0x08, 0x64, 0x65, 0x66, 0x61, 0x75, 0x6c, 0x74,
	...
	,
	...
	,
	...
	,
	...
	0x05, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x22, 0x83, 0x01, 0x0a, 0x08, 0x50, 0x61, 0x74, 0x68, 0x45,
	0x6c, 0x65, 0x6d, 0x12, 0x12, 0x0a, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x12, 0x2b, 0x0a, 0x03, 0x6b, 0x65, 0x79, 0x18, 0x02,
	0x20, 0x03, 0x28, 0x0b, 0x32, 0x19, 0x2e, 0x73, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x2e, 0x50, 0x61,
	...
	,
	...
	0x6e, 0x22, 0x99, 0x01, 0x0a, 0x0a, 0x43, 0x68, 0x6f, 0x69, 0x63, 0x65, 0x49, 0x6e, 0x66, 0x6f,
	0x12, 0x36, 0x0a, 0x06, 0x63, 0x68, 0x6f, 0x69, 0x63, 0x65, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b,
	0x32, 0x1e, 0x2e, 0x73, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x2e, 0x43, 0x68, 0x6f, 0x69, 0x63, 0x65,
	0x49, 0x6e, 0x66, 0x6f, 0x2e, 0x43, 0x68, 0x6f, 0x69, 0x63, 0x65, 0x45, 0x6e, 0x74, 0x72, 0x79,
	0x52, 0x06, 0x63, 0x68, 0x6f, 0x69, 0x63, 0x65, 0x1a, 0x53, 0x0a, 0x0b, 0x43, 0x68, 0x6f, 0x69,
	...
	0x61, 0x2e, 0x43, 0x68, 0x6f, 0x69, 0x63, 0x65, 0x49, 0x6e, 0x66, 0x6f, 0x43, 0x68, 0x6f, 0x69,
	0x63, 0x65, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0x97, 0x01,
	0x0a, 0x10, 0x43, 0x68, 0x6f, 0x69, 0x63, 0x65, 0x49, 0x6e, 0x66, 0x6f, 0x43, 0x68, 0x6f, 0x69,
	0x63, 0x65, 0x12, 0x36, 0x0a, 0x04, 0x63, 0x61, 0x73, 0x65, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b,
	0x32, 0x22, 0x2e, 0x73, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x2e, 0x43, 0x68, 0x6f, 0x69, 0x63, 0x65,
	0x49, 0x6e, 0x66, 0x6f, 0x43, 0x68, 0x6f, 0x69, 0x63, 0x65, 0x2e, 0x43, 0x61, 0x73, 0x65, 0x45,
	0x6e, 0x74, 0x72, 0x79, 0x52, 0x04, 0x63, 0x61, 0x73, 0x65, 0x1a, 0x4b, 0x0a, 0x09, 0x43, 0x61,
	...
	0x75, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x12, 0x2e, 0x73, 0x63, 0x68, 0x65, 0x6d,
	0x61, 0x2e, 0x43, 0x68, 0x6f, 0x69, 0x63, 0x65, 0x43, 0x61, 0x73, 0x65, 0x52, 0x05, 0x76, 0x61,
	0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0x28, 0x0a, 0x0a, 0x43, 0x68, 0x6f, 0x69, 0x63,
	0x65, 0x43, 0x61, 0x73, 0x65, 0x12, 0x1a, 0x0a, 0x08, 0x65, 0x6c, 0x65, 0x6d, 0x65, 0x6e, 0x74,
	0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x09, 0x52, 0x08, 0x65, 0x6c, 0x65, 0x6d, 0x65, 0x6e, 0x74,
	0x73, 0x2a, 0x43, 0x0a, 0x0c, 0x53, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x53, 0x74, 0x61, 0x74, 0x75,
	...
	,
	...
	,
	...
	,
...
var file_schema_proto_goTypes = []any{
	...
	(*UniqueConstraint)(nil),         // 28: schema.UniqueConstraint
	(*MandatoryChild)(nil),           // 29: schema.MandatoryChild
	(*LeafListSchema)(nil),           // 30: schema.LeafListSchema
	(*LeafSchema)(nil),               // 31: schema.LeafSchema
	(*SchemaLeafType)(nil),           // 32: schema.SchemaLeafType
	(*MustStatement)(nil),            // 33: schema.MustStatement
	(*PathElem)(nil),                 // 34: schema.PathElem
	(*Path)(nil),                     // 35: schema.Path
	(*SchemaPattern)(nil),            // 36: schema.SchemaPattern
	(*SchemaMinMaxType)(nil),         // 37: schema.SchemaMinMaxType
	(*Number)(nil),                   // 38: schema.Number
	(*Bit)(nil),                      // 39: schema.Bit
	(*ChoiceInfo)(nil),               // 40: schema.ChoiceInfo
	(*ChoiceInfoChoice)(nil),         // 41: schema.ChoiceInfoChoice
	(*ChoiceCase)(nil),               // 42: schema.ChoiceCase
	nil,                              // 43: schema.SchemaLeafType.IdentityPrefixesMapEntry
	nil,                              // 44: schema.SchemaLeafType.ModulePrefixMapEntry
	nil,                              // 45: schema.PathElem.KeyEntry
	nil,                              // 46: schema.ChoiceInfo.ChoiceEntry
	nil,                              // 47: schema.ChoiceInfoChoice.CaseEntry
}
var file_schema_proto_depIdxs = []int32{
	...
	35, // 4: schema.GetSchemaRequest.path:type_name -> schema.Path
	...
	31, // 8: schema.SchemaElem.field:type_name -> schema.LeafSchema
	30, // 9: schema.SchemaElem.leaflist:type_name -> schema.LeafListSchema
	...
	35, // 20: schema.ToPathResponse.path:type_name -> schema.Path
	35, // 21: schema.ExpandPathRequest.path:type_name -> schema.Path
	...
	35, // 24: schema.ExpandPathResponse.path:type_name -> schema.Path
	3,  // 25: schema.Hash.method:type_name -> schema.Hash.HashMethod
	31, // 26: schema.ContainerSchema.keys:type_name -> schema.LeafSchema
	31, // 27: schema.ContainerSchema.fields:type_name -> schema.LeafSchema
	30, // 28: schema.ContainerSchema.leaflists:type_name -> schema.LeafListSchema
	29, // 29: schema.ContainerSchema.mandatory_children:type_name -> schema.MandatoryChild
	33, // 30: schema.ContainerSchema.must_statements:type_name -> schema.MustStatement
	28, // 31: schema.ContainerSchema.unique_constraints:type_name -> schema.UniqueConstraint
	40, // 32: schema.ContainerSchema.choice_info:type_name -> schema.ChoiceInfo
	32, // 33: schema.LeafListSchema.type:type_name -> schema.SchemaLeafType
	33, // 34: schema.LeafListSchema.must_statements:type_name -> schema.MustStatement
	32, // 35: schema.LeafSchema.type:type_name -> schema.SchemaLeafType
	33, // 36: schema.LeafSchema.must_statements:type_name -> schema.MustStatement
	37, // 37: schema.SchemaLeafType.range:type_name -> schema.SchemaMinMaxType
	37, // 38: schema.SchemaLeafType.length:type_name -> schema.SchemaMinMaxType
	36, // 39: schema.SchemaLeafType.patterns:type_name -> schema.SchemaPattern
	32, // 40: schema.SchemaLeafType.union_types:type_name -> schema.SchemaLeafType
	43, // 41: schema.SchemaLeafType.identity_prefixes_map:type_name -> schema.SchemaLeafType.IdentityPrefixesMapEntry
	44, // 42: schema.SchemaLeafType.module_prefix_map:type_name -> schema.SchemaLeafType.ModulePrefixMapEntry
	32, // 43: schema.SchemaLeafType.leafref_target_type:type_name -> schema.SchemaLeafType
	39, // 44: schema.SchemaLeafType.bits:type_name -> schema.Bit
	45, // 45: schema.PathElem.key:type_name -> schema.PathElem.KeyEntry
	34, // 46: schema.Path.elem:type_name -> schema.PathElem
	38, // 47: schema.SchemaMinMaxType.min:type_name -> schema.Number
	38, // 48: schema.SchemaMinMaxType.max:type_name -> schema.Number
	46, // 49: schema.ChoiceInfo.choice:type_name -> schema.ChoiceInfo.ChoiceEntry
	47, // 50: schema.ChoiceInfoChoice.case:type_name -> schema.ChoiceInfoChoice.CaseEntry
	41, // 51: schema.ChoiceInfo.ChoiceEntry.value:type_name -> schema.ChoiceInfoChoice
	42, // 52: schema.ChoiceInfoChoice.CaseEntry.value:type_name -> schema.ChoiceCase
	5,  // 53: schema.SchemaServer.GetSchemaDetails:input_type -> schema.GetSchemaDetailsRequest
	7,  // 54: schema.SchemaServer.ListSchema:input_type -> schema.ListSchemaRequest
	9,  // 55: schema.SchemaServer.GetSchema:input_type -> schema.GetSchemaRequest
	12, // 56: schema.SchemaServer.CreateSchema:input_type -> schema.CreateSchemaRequest
	14, // 57: schema.SchemaServer.ReloadSchema:input_type -> schema.ReloadSchemaRequest
	16, // 58: schema.SchemaServer.DeleteSchema:input_type -> schema.DeleteSchemaRequest
	18, // 59: schema.SchemaServer.UploadSchema:input_type -> schema.UploadSchemaRequest
	20, // 60: schema.SchemaServer.ToPath:input_type -> schema.ToPathRequest
	22, // 61: schema.SchemaServer.ExpandPath:input_type -> schema.ExpandPathRequest
	9,  // 62: schema.SchemaServer.GetSchemaElements:input_type -> schema.GetSchemaRequest
	6,  // 63: schema.SchemaServer.GetSchemaDetails:output_type -> schema.GetSchemaDetailsResponse
	8,  // 64: schema.SchemaServer.ListSchema:output_type -> schema.ListSchemaResponse
	10, // 65: schema.SchemaServer.GetSchema:output_type -> schema.GetSchemaResponse
	13, // 66: schema.SchemaServer.CreateSchema:output_type -> schema.CreateSchemaResponse
	15, // 67: schema.SchemaServer.ReloadSchema:output_type -> schema.ReloadSchemaResponse
	17, // 68: schema.SchemaServer.DeleteSchema:output_type -> schema.DeleteSchemaResponse
	26, // 69: schema.SchemaServer.UploadSchema:output_type -> schema.UploadSchemaResponse
	21, // 70: schema.SchemaServer.ToPath:output_type -> schema.ToPathResponse
	23, // 71: schema.SchemaServer.ExpandPath:output_type -> schema.ExpandPathResponse
	10, // 72: schema.SchemaServer.GetSchemaElements:output_type -> schema.GetSchemaResponse
