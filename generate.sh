...
clang-format -i -style=file:clang-format.style options.proto
...
protoc --go_out=paths=source_relative:$SCHEMA_OUT_DIR --go-grpc_out=paths=source_relative:$SCHEMA_OUT_DIR -I $SCRIPTPATH $SCRIPTPATH/options.proto $SCRIPTPATH/schema.proto $SCRIPTPATH/data.proto
